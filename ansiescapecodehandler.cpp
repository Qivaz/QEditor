 ...
 * Copy from: https://code.qt.io/cgit/qt-creator/qt-creator.git/tree/src/libs/utils/ansiescapecodehandler.cpp
 *
...
#define QTC_ASSERT(a, b) do { if (!(a)) { b; } } while(0)
/*!
